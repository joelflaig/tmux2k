...
start_icon() {
    ...
    tmux set-option -g status-left "#[fg=${wfg},bg=${wbg}]${wl_sep}#[bg=${!first_colors[0]},fg=${!first_colors[1]}]#{?client_prefix,#[bg=${light_yellow},} ${start_icon} #[fg=${bg_alt},bg=${wbg}]${wr_sep}"
}
